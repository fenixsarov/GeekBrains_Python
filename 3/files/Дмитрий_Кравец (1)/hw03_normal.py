...
# 2016.12.04 15:33:17 checked. P.Rusanov
# Отлично!
print(40*'=','\nЗадание-1:\n')
...
def fibonacci(n, m):
    ...
    num1 = num2 = 1
    num_sum = 0
    num_lst = list()        # лучше использовать  num_lst = []  (чуток побыстрее будет)
...
# 2016.12.04 15:38:22 checked. P.Rusanov
# Классно!
...
# 2016.12.04 15:38:34 checked. P.Rusanov
# Хитрооо :)
print(40*'=','\nЗадание-2:\n')
