...
# 2016.12.04 00:55:11 checked. P.Rusanov
# Отлично!
k = float(equation.split('x')[0].split('y = ')[1])

tmp = equation.split('x')[1]
if '+' in tmp:
    b = float(tmp.split(' + ')[1])
elif '-' in tmp:
    b = -float(tmp.split(' - ')[1])

print('Коэффициенты k и b равно {} и {} соответственно'.format(k, b))
